...
@Component
public class DoubleRoundRobinStrategy implements ScheduleStrategy {

    @Override
    public List<Match> generateSchedule(List<Team> teams, ScheduleConfig config) {
        return RoundRobinGenerator.generate(teams, config, true);
    }

    @Override
    public ScheduleType getScheduleType() {
        return ScheduleType.DOUBLE_ROUND_ROBIN;
    }
}
